...
def get_dataloaders(args):
    ...
    dataset["train"] = data.DataLoader(dataset=train_data, batch_size=1, shuffle=False, num_workers=2)
    valid_data = Dataset(valid_data, subjects_dict, "val")
    dataset["valid"] = data.DataLoader(dataset=valid_data, batch_size=1, shuffle=False, num_workers=2)
    test_data = Dataset(test_data, subjects_dict, "test")
    dataset["test"] = data.DataLoader(dataset=test_data, batch_size=1, shuffle=False, num_workers=2)
    return dataset
