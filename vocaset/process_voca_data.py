...
def main():
    ...
    parser.add_argument("--verts_path", type=str, default=" ")
    parser.add_argument("--vertices_npy_path", type=str, default=" ")
    parser.add_argument("--vertices_dim", type=int, default=5023*3)
    parser.add_argument("--raw_audio_path", type=str, default=' ')
