...
addpath('D:/数据集/BIWI/data_preprocess/Utils');
...
for subject_id = subjects
    ...
    sourcepath = ['D:/数据集/BIWI/BIWI/faces' '/' subject_id  '/'];  %data path
    
    % Define your targetpath for saving data here
    targetpath = ['D:/数据集/BIWI/BIWI/BIWI_process','/','data','/', subject_id, '/'];
    templatepath = ['D:/数据集/BIWI/BIWI/rigid_scans','/', [subject_id,'.obj']];
    filetype = 'vl';
